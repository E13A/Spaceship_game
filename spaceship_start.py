...
exit_button = button.Button(340, 4000, exit_img, 0.8)
start_button = button.Button(230, 700, start_img, 1.2)
...
for i in range (num_of_enemies):
	...
	enemyY.append(random.randint(-4000,-1000))
...
while running:
	...
	if start_button.draw(screen):
		...
		start_button = button.Button(340, 4000, start_img, 0.8)
		player1Y = 1350
		textX = 10
		textY = 10
